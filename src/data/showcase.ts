...
// Vídeos
const v1 = '/show-cases/sc-cajubrasil-v3.mp4'
const v2 = '/show-cases/sc-camys-v3.mp4'
const v3 = '/show-cases/sc-ferragens-v3.mp4'
const v4 = '/show-cases/sc-majeste-v3.mp4'
const v5 = '/show-cases/sc-mamo-v3.mp4'

    ...
    >
      ...
      >
        ...
        <div className="relative z-[2] flex flex-col justify-center px-12 py-16 w-1/2 shrink-0">
          <h2 id="newsletter-heading" className="text-3xl font-normal text-white leading-[1.25] mb-6">
            {t('newsletter.title')}
          </h2>
          <form
          ...
          >
            ...
            <input
              ...
              autoComplete="name"
              required
              className="w-full bg-white/10 border border-white/20 rounded-[8px] px-4 py-3 text-sm text-white placeholder-white/40 outline-none focus:border-brand/70 transition-colors"
            />

    ...
    >
      ...
      <div className="flex md:hidden gap-4 overflow-x-auto snap-x snap-mandatory pb-4 -mr-3 pl-0 pr-3 scrollbar-hide">
            ...
            <div>
              <div className="flex mb-4 mt-4">
                <div className="flex flex-col gap-1 flex-1 items-center text-center">
                  ...
                  <span className="text-text-muted text-base leading-snug">Mais tempo na página com vídeo</span>
                </div>
                <div className="w-px bg-surface-border" />
                <div className="flex flex-col gap-1 flex-1 items-center text-center">
                  <CountUp target={4} suffix="x" className="text-3xl md:text-3xl lg:text-4xl font-normal text-charcoal leading-none mb-1" />
                  <span className="text-text-muted text-base leading-snug">Mais conversão de vendas</span>
                </div>
              </div>
        ...
        <SolutionArticle direction="left" id="live-commerce-mobile" mobileCarousel>
          ...
          <div className="flex flex-col flex-1 px-0 justify-between py-0">
            <div>
              <span className="inline-block bg-charcoal text-white text-xs font-bold px-3 py-1 rounded-full w-fit mb-4">Novo</span>
              <h3 className="text-2xl font-normal text-black mb-4 leading-tight">Live Commerce</h3>
              <p className="text-text-body text-base max-w-full">
              ...
              <div className="flex mt-6">
                <div className="flex flex-col gap-1 flex-1 items-center text-center">
                  <CountUp target={5} suffix="x" className="text-3xl md:text-3xl lg:text-4xl font-normal text-charcoal leading-none mb-1" />
                  <span className="text-text-muted text-base leading-snug">Maior engajamento vs. redes sociais</span>
                </div>
                <div className="w-px bg-surface-border" />
                <div className="flex flex-col gap-1 flex-1 items-center text-center">
                  <CountUp target={60} prefix="+" suffix="%" className="text-3xl md:text-3xl lg:text-4xl font-normal text-charcoal leading-none mb-1" />
                  <span className="text-text-muted text-base leading-snug">Maior ticket médio durante a live</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <SolutionArticle direction="left" id="provador-ia-mobile" mobileCarousel>
          ...
          <div className="flex flex-col flex-1 px-0 justify-between py-0">
            <div>
              <span className="inline-block bg-charcoal text-white text-xs font-bold px-3 py-1 rounded-full w-fit mb-4">Novo</span>
              <h3 className="text-2xl font-normal text-black mb-4 leading-tight">Provador IA</h3>
              <p className="text-text-body text-base max-w-full">
              ...
              <div className="flex mt-6">
                <div className="flex flex-col gap-1 flex-1 items-center text-center">
                  ...
                  <span className="text-text-muted text-base leading-snug">Satisfação dos consumidores com o resultado</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="hidden md:flex flex-col gap-16 lg:gap-24 overflow-hidden">
            ...
            <div>
              <div className="flex gap-5 md:gap-6 lg:gap-8 mb-6 md:mb-6 lg:mb-8 mt-6 md:mt-6 lg:mt-8">
                <div className="flex flex-col gap-1">
                  <CountUp target={5} suffix="x" className="text-3xl md:text-3xl lg:text-4xl font-normal text-charcoal leading-none mb-1" />
                  <span className="text-text-muted md:text-lg leading-snug">Mais tempo na página com vídeo</span>
                </div>
                <div className="w-px bg-surface-border" />
                <div className="flex flex-col gap-1">
                  <CountUp target={4} suffix="x" className="text-3xl md:text-3xl lg:text-4xl font-normal text-charcoal leading-none mb-1" />
                  <span className="text-text-muted md:text-lg leading-snug">Mais conversão de vendas</span>
                </div>
              </div>
        ...
        <SolutionArticle direction="right" id="live-commerce">
          ...
          <div className="flex flex-col flex-1 px-5 md:px-6 lg:px-8 justify-between py-6 md:py-6 lg:py-8">
            <div>
              <span className="inline-block bg-charcoal text-white text-xs md:text-base font-bold px-3 py-1 rounded-full w-fit mb-4">Novo</span>
              <h3 className="text-2xl md:text-2xl lg:text-3xl font-normal text-black mb-4 leading-tight">Live Commerce</h3>
              <p className="text-text-body md:text-lg max-w-full">
                <strong>Transmissão ao vivo onde a venda acontece.</strong>{" "}O consumidor assiste, engaja, tira dúvidas em tempo real, vê detalhes do produto ao vivo e compra durante a live, sem sair do seu site.
              </p>
              <p className="text-text-body md:text-lg mt-4 max-w-full">
            ...
            <div>
              <div className="flex gap-5 md:gap-6 lg:gap-8 mb-6 md:mb-6 lg:mb-8 mt-6 md:mt-6 lg:mt-8">
                <div className="flex flex-col gap-1">
                  <CountUp target={5} suffix="x" className="text-3xl md:text-3xl lg:text-4xl font-normal text-charcoal leading-none mb-1" />
                  <span className="text-text-muted md:text-lg leading-snug">Maior engajamento vs. redes sociais</span>
                </div>
                <div className="w-px bg-surface-border" />
                <div className="flex flex-col gap-1">
                  <CountUp target={60} prefix="+" suffix="%" className="text-3xl md:text-3xl lg:text-4xl font-normal text-charcoal leading-none mb-1" />
                  <span className="text-text-muted md:text-lg leading-snug">Maior ticket médio durante a live</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <SolutionArticle direction="left" id="provador-ia">
          ...
          <div className="flex flex-col flex-1 px-5 md:px-6 lg:px-8 justify-between py-6 md:py-6 lg:py-8">
            <div>
              <span className="inline-block bg-charcoal text-white text-xs font-bold px-3 py-1 rounded-full w-fit mb-4">Novo</span>
              <h3 className="text-2xl md:text-2xl lg:text-3xl font-normal text-black mb-4 leading-tight">Provador IA</h3>
              <p className="text-text-body md:text-lg max-w-full">
                Seu cliente prova o produto no próprio corpo, através de uma foto, como se estivesse na loja física, mas no seu site.{" "}<strong>Para vestuário e calçados: ele vê como fica antes de decidir.</strong>
              </p>
              <p className="text-text-body md:text-lg mt-4 max-w-full">
            ...
            <div>
              <div className="flex gap-5 md:gap-6 lg:gap-8 mb-6 md:mb-6 lg:mb-8 mt-6 md:mt-6 lg:mt-8">
                <div className="flex flex-col gap-1">
                  <CountUp target={93} suffix="%" className="text-3xl md:text-3xl lg:text-4xl font-normal text-charcoal leading-none mb-1" />
                  <span className="text-text-muted md:text-lg leading-snug">Satisfação dos consumidores com o resultado</span>
                </div>
              </div>
            </div>
          </div>

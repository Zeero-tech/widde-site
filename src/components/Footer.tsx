      ...
      <div className="px-5 md:px-2 max-w-screen-xl mx-auto pt-16 md:pt-40 pb-6 md:pb-10">
        ...
        <div className="flex justify-between items-start flex-wrap gap-6 mb-8 md:mb-12">
          ...
          <div className="flex gap-5" aria-label={t("footer.socialMedia")}>
            ...
            <a
              href="https://www.instagram.com/widde.io/"
              className="footer-social"
            ...
            <a
              href="https://www.linkedin.com/company/widde/"
              className="footer-social"
              aria-label="LinkedIn"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.tiktok.com/@widde.io"
              className="footer-social"
              aria-label="TikTok"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="flex justify-between items-end flex-wrap gap-6">
          <nav
            ...
            aria-label={t("footer.footerLinks")}
          >
            ...
            <a
              href="https://widde.io/quem-somos?utm_medium=cpc&utm_source=google&utm_campaign=01"
            ...
            <a
              href="https://carreirawidde.lovable.app/"
              className="footer-link"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://widde.io/blog?utm_medium=cpc&utm_source=google&utm_campaign=01"
              className="footer-link"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://intercom.help/widde/pt-BR/"
              className="footer-link"
              target="_blank"
              rel="noopener noreferrer"
            >

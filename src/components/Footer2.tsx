  ...
  return (
    <footer className="bg-[#f6f6f6] text-black" role="contentinfo">
      <div className="px-5 md:px-2 max-w-screen-xl mx-auto pt-16 pb-8">
        {/* Newsletter row */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 pb-10 border-b border-black/10">
          <div>
          ...
          <form className="flex gap-2 w-full md:w-auto">
            <input
              ...
              required
              className="w-full md:w-[280px] bg-white border border-black/10 rounded-lg px-4 py-2.5 text-sm text-black placeholder-black/40 outline-none focus:border-black/30 transition-colors"
            />
            <button
              type="submit"
              className="bg-black text-white text-sm font-bold px-5 py-2.5 rounded-lg border-none cursor-pointer whitespace-nowrap hover:bg-black/80 transition-colors"
            >
              Inscrever-se
            </button>
          </form>

    ...
    <section className="bg-[#f6f6f6] py-10 md:py-16">
      <div className=" max-w-screen-xl mx-auto px-2">
        ...
        >
          ...
          >
            <span className="block text-base font-bold bg-brand text-white px-2 uppercase tracking-[2.5px] mb-6">
              {t("hero.tagline")}
            </span>
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center">
              ...
              <AnimatedButton
                ...
                className="inline-block bg-transparent text-white font-bold px-7 py-[13px] rounded-full no-underline border border-white/30 hover:border-white transition-colors"
              >
                {t("hero.ctaLearnMore")}
              </AnimatedButton>
            </div>

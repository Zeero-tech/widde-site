    ...
    <section className="bg-[#f6f6f6] py-10 md:py-16">
      <div className=" max-w-screen-xl mx-auto px-2">
        ...
        >
          ...
          >
            <span className="block text-xs font-bold text-brand uppercase tracking-[2.5px] mb-6">
              {t("hero.tagline")}
            </span>

            <h1 className="text-white text-4xl md:text-7xl lg:text-9xl font-black leading-[1.1] mb-6 max-w-[800px]">
              {t("hero.title")}{" "}
              <span className="text-brand">{t("hero.titleHighlight")}</span>
            </h1>

            <p className="text-white/70 text-sm md:text-base leading-[1.7] mb-1 max-w-[720px]">
              {t("hero.description")}
            </p>
            <p className="font-bold text-white/80 text-sm md:text-base leading-[1.7] mb-10 max-w-[720px]">
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center">
              ...
              <AnimatedButton
                ...
                className="inline-block bg-transparent text-white text-sm font-bold px-7 py-[13px] rounded-full no-underline border border-white/30 hover:border-white transition-colors"
              >
                {t("hero.ctaLearnMore")}
              </AnimatedButton>
            </div>

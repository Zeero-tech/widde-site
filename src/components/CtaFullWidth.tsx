      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          ...
          <AnimatedButton
            ...
            className="inline-block bg-transparent text-white text-sm font-bold px-7 py-[13px] rounded-full no-underline border-[1.5px] border-white/25 hover:border-white transition-colors"
          >
            Falar com vendas
          </AnimatedButton>
        </div>

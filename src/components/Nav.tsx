    ...
    >
      <div className="px-8 max-w-[1440px] mx-auto ">
        <nav className="flex justify-between items-center p-3 relative min-h-[4.5rem]">
          <a href="/" aria-current="page" className="no-underline flex items-center text-black" style={{ overflow: 'hidden', display: 'inline-flex' }} onClick={(e) => { e.preventDefault(); if (location.pathname === '/') { getLenis().scrollTo(0, { duration: 3, easing: (t) => 1 - Math.pow(1 - t, 5) }) } else { navigate('/') } }}>
          ...
          <button
            className="md:hidden bg-transparent border-none text-2xl cursor-pointer text-black p-2"

  ...
  return (
    <div ref={ref} className="relative flex items-center">
      ...
      >
        ...
        <svg width="10" height="10" viewBox="0 0 12 12" fill="none" style={{ transition: 'transform 0.2s', transform: open ? 'rotate(180deg)' : 'rotate(0deg)' }}>
          <path d="M2 4L6 8L10 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </button>
        ...
        >
          {[
            ...
            <button
              ...
              onMouseEnter={e => { if (current !== code) (e.currentTarget as HTMLButtonElement).style.background = '#f6f6f6' }}
              onMouseLeave={e => { if (current !== code) (e.currentTarget as HTMLButtonElement).style.background = 'transparent' }}
            >
              {label}
            </button>
          ))}
      ...
      <div className="px-4 md:px-8 max-w-[1440px] mx-auto ">
        <nav className="flex justify-between items-center p-3 relative min-h-[4.5rem]">
          ...
          >
            ...
            <NavLink href="https://widde.io/cases" label={t('nav.results')} onClose={handleNav} dark={isDark} />
            <NavLink href="#planos" label={t('nav.plans')} onClose={handleNav} dark={isDark} />
            <NavLink href="https://widde.io/blog" label={t('nav.blog')} onClose={handleNav} dark={isDark} />

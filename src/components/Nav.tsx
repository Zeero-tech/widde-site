...
function SolucoesDropdown({ onClose, navigate, location, dark }: { onClose: () => void; navigate: ReturnType<typeof useNavigate>; location: ReturnType<typeof useLocation>; dark?: boolean }) {
...
function NavLink({ href, label, onClose, dark }: { href: string; label: string; onClose: () => void; dark?: boolean }) {
  ...
  function handleClick(e: React.MouseEvent<HTMLAnchorElement>) {
    ...
    e.preventDefault()
    onClose()
    getLenis().scrollTo(href, { duration: 3, offset: -50, easing: (t) => 1 - Math.pow(1 - t, 5) })
  }
      ...
      <div className="px-8 max-w-[1440px] mx-auto ">
        <nav className="flex justify-between items-center p-3 relative min-h-[4.5rem]">
          ...
          <div
            ...
            `}
          >
            <SolucoesDropdown onClose={handleNav} navigate={navigate} location={location} dark={isDark} />

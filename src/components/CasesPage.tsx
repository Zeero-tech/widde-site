      ...
      <main>
        ...
        <section className="bg-white pt-8 pb-0">
          <div className="px-5 md:px-10 lg:px-12 xl:px-6 max-w-screen-xl mx-auto">
            <h1 className="font-normal text-black leading-[1.15] mb-6" style={{ fontSize: "3rem" }}>
              Cases de sucesso
            </h1>
            <p className="text-[#373739] text-lg mb-8">
              Veja como tem sido <strong>os resultados</strong> de quem usa as <strong>soluções de Video Commerce</strong> da Widde.
            </p>
            ...
            >
              {/* Imagem — esquerda */}
              <div className="relative overflow-hidden group" style={{ flex: "0 0 58%", minHeight: "320px" }}>
                <div
                  className="absolute inset-0 transition-transform duration-500 ease-out group-hover:scale-[1.08]"
                  style={{
                    backgroundImage: "url('https://cdn.prod.website-files.com/65596f4cd628c3fb6449f35f/695d2d0b1016c8df8923096d_capa%20youtube%201.png')",
                ...
                />
                <div className="absolute inset-0" style={{ backgroundColor: "rgba(0,0,0,0.3)", zIndex: 1 }} />
                <div className="absolute inset-0 flex items-center justify-center" style={{ padding: "2rem", zIndex: 2 }}>
                  <img
                    loading="lazy"
                    ...
                    style={{ aspectRatio: "16/9", objectFit: "cover", objectPosition: "50% 50%", borderRadius: "1rem", width: "100%", position: "relative" }}
                  />
                </div>
              </div>
              ...
              <div
                ...
                style={{ flex: "0 0 42%", backgroundColor: "#f2f2f2" }}
              >
                <span
                ...
                <h2 className="font-normal text-black leading-[1.2] mb-8" style={{ fontSize: "2.5rem" }}>
            ...
            <div className="padding-global">
              <div className="container-large">
                ...
                <div className="filter-list w-dyn-list">
                  <div role="list" className="blog_post-wrapper is--cases w-dyn-items">
                    {cases.map((c) => (
                      <div key={c.href} role="listitem" className="blog_post-item-wrapper w-dyn-item">
                        <div className="cases_post-item">
                          <a href={c.href} className="blog_post-thumbnail-wrapper w-inline-block">
                            <img
                              src={c.image}
                              loading="lazy"
                              alt=""
                          ...
                          <div className="blog_post-content">
                            ...
                            <div className="align-bottom">
                              <a aria-label="staggering button" href={c.href} className="btn-animate-chars widde-lp resultados-mam w-inline-block">
                                <div className="btn-animate-chars__bg"></div>
                                <span className="btn-animate-chars__text">Ver case de sucesso</span>

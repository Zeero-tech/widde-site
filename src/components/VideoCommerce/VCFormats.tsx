  ...
  const formats = [
    {
      ...
      onde: t("vc.formats.stories.locations", {
        returnObjects: true,
      }) as string[],
      thumb: (
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="flex gap-[6px]">
              {[1, 2, 3].map((n) => (
                <div
                  key={n}
                  className="w-[24px] h-[24px] rounded-full bg-brand/25 border border-brand/40"
                />
              ))}
            </div>
            <div className="w-[70px] h-[110px] rounded-[10px] bg-brand border-2 border-white/40 relative overflow-hidden">
              <div className="flex gap-[3px] absolute top-[6px] left-[5px] right-[5px]">
                {[1, 2, 3].map((d, i) => (
                  <div
                    key={d}
                    className={`h-[2px] flex-1 rounded-full ${i === 0 ? "bg-white" : "bg-white/35"}`}
                  />
                ))}
              </div>
    ...
    },
    {
      ...
      onde: t("vc.formats.carousel.locations", {
        returnObjects: true,
      }) as string[],
      thumb: (
        <div className="h-[190px] flex items-center justify-center bg-gradient-to-br from-[#E0F2FE] to-[#BAE6FD]">
          <div className="flex gap-1 items-end px-3">
            <div
              className="w-[32px] h-[58px] rounded-[7px] flex-shrink-0"
              style={{ background: "rgba(14,165,233,0.25)" }}
            />
            <div
              className="w-[42px] h-[78px] rounded-[7px] flex-shrink-0"
              style={{ background: "rgba(14,165,233,0.25)" }}
            />
            <div
              className="w-[56px] h-[100px] rounded-[7px] flex-shrink-0"
    ...
    },
    {
      ...
      onde: t("vc.formats.highlights.locations", {
        returnObjects: true,
      }) as string[],
      thumb: (
        <div className="h-[190px] flex items-center justify-center bg-gradient-to-br from-[#EFF6FF] to-[#BFDBFE]">
          <div className="flex flex-col gap-[6px] px-3 w-full">
            <div
              className="rounded-lg h-[60px] flex items-center px-[10px]"
              style={{ background: "#3B82F6" }}
            >
              <span className="text-xs font-black text-white">
                Festival Jaquetas · R$ 99
              </span>
            </div>
    ...
    },
    {
      ...
      onde: t("vc.formats.productHighlights.locations", {
        returnObjects: true,
      }) as string[],
      thumb: (
        <div className="h-[190px] flex items-center justify-center bg-gradient-to-br from-[#EEF2FF] to-[#C7D2FE]">
          <div className="flex flex-col gap-[6px] px-[10px] py-[10px] w-full">
            <div className="flex gap-2">
              <div
                className="w-[60px] h-[80px] rounded-[7px] flex-shrink-0"
                style={{ background: "rgba(99,102,241,0.25)" }}
              />
              <div className="flex-1">
                <div className="text-xs font-bold text-[#333] mb-[3px]">
                  Protetor Solar FPS 90
                </div>
                <div
                  className="text-xs font-black mb-[5px]"
                  style={{ color: "#6366F1" }}
                >
                  R$ 89,90
                </div>
                <div className="flex gap-[3px] flex-wrap">
                  {["Como usar", "Ingredientes"].map((tab) => (
                    <span
                      key={tab}
                      className="text-xs font-bold rounded-full px-[5px] py-[2px]"
                      style={{
    ...
    },
    {
      ...
      onde: t("vc.formats.explore.locations", {
        returnObjects: true,
      }) as string[],
      thumb: (
        <div className="h-[190px] bg-gradient-to-br from-[#E8F0FF] to-[#B8CCFF] px-[10px] py-[8px] flex flex-col gap-[4px]">
          ...
          <div
            ...
            style={{ background: "rgba(38,103,248,0.12)" }}
          />
          {/* Tags */}
            ...
            {[20, 14, 16, 18, 12].map((w, i) => (
              <div
                ...
                style={{
                  width: w,
                  background:
                    i === 0 ? "rgba(38,103,248,0.7)" : "rgba(38,103,248,0.2)",
                }}
              />
            ))}
          </div>
          ...
          >
            ...
            <div
              ...
              style={{
                gridColumn: "1",
                gridRow: "1 / 3",
                background: "rgba(38,103,248,0.7)",
              }}
            />
            {/* Row 1: cols 2-4 */}
            <div
              ...
              style={{
                gridColumn: "2",
                gridRow: "1",
                background: "rgba(38,103,248,0.5)",
              }}
            />
            <div
              className="rounded-[4px]"
              style={{
                gridColumn: "3",
                gridRow: "1",
                background: "rgba(38,103,248,0.25)",
              }}
            />
            <div
              className="rounded-[4px]"
              style={{
                gridColumn: "4",
                gridRow: "1",
                background: "rgba(38,103,248,0.35)",
              }}
            />
            {/* Row 2: cols 2-4 */}
            <div
              ...
              style={{
                gridColumn: "2",
                gridRow: "2",
                background: "rgba(38,103,248,0.2)",
              }}
            />
            <div
              className="rounded-[4px]"
              style={{
                gridColumn: "3",
                gridRow: "2",
                background: "rgba(38,103,248,0.4)",
              }}
            />
            <div
              className="rounded-[4px]"
          ...
          <div
            ...
            style={{ gridTemplateColumns: "repeat(4, 1fr)", height: 16 }}
          >
            {[0.18, 0.18, 0.45, 0.18].map((op, i) => (
              <div
                key={i}
                className="rounded-[4px]"
                style={{ background: `rgba(38,103,248,${op})` }}
              />
            ))}
          </div>
        </div>

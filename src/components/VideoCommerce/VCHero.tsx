  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 md:top-5 left-0 right-0 h-[60px] z-10 flex">
        <div className="w-full max-w-screen-xl mx-auto px-5 md:px-10 lg:px-12 xl:px-2 flex">
      ...
      <div
        className="max-w-screen-xl mx-auto px-5 md:px-10 lg:px-12 xl:px-2 h-full flex items-center"

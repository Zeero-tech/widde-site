    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h1 className="text-[2.625rem] md:text-[2.5rem] lg:text-5xl font-black leading-[1.15] mb-8 md:mb-6 text-white">
              {t("vc.hero.title")}{" "}
            ...
            <p className="text-lg md:text-base lg:text-lg text-[#aaa] leading-[1.7] mb-6 md:mb-6 lg:mb-8 max-w-full md:max-w-[560px]">
              {t("vc.hero.description2")}
            </p>
            <ul className="list-none flex flex-col gap-[12px] md:gap-[10px] mb-10 md:mb-8 lg:mb-10 p-0">
              {[
                t("vc.hero.feature1"),
                t("vc.hero.feature2"),
                t("vc.hero.feature3"),
                ...
                <li
                  key={item}
                  className="text-lg md:text-base lg:text-lg text-[#ccc] flex items-start gap-[10px]"
                >
                  <span className="w-[20px] h-[20px] md:w-[18px] md:h-[18px] rounded-full flex items-center justify-center flex-shrink-0 mt-[2px] md:mt-[1px] text-xs font-black bg-brand/[0.12] text-brand">
                    ✓
                  </span>
                  {item}
                </li>
            ...
            <div className="mt-8 md:mt-0  flex flex-col items-stretch md:flex-row md:items-center gap-4 md:gap-3">
              <AnimatedButton
                href="https://widde.io/contato-vendas?utm_medium=cpc&utm_source=google&utm_campaign=01"
                className="inline-block text-center bg-brand text-white font-bold text-lg md:text-base lg:text-lg px-5 md:px-5 lg:px-7 py-[12px] md:py-[11px] lg:py-[13px] rounded-full no-underline"
              >
                {t("vc.hero.ctaSales")}
              </AnimatedButton>
              <a
                ...
                className="btn-animate-chars inline-flex items-center justify-center text-center bg-transparent text-white font-bold text-lg md:text-base lg:text-lg px-5 md:px-5 lg:px-7 py-[12px] md:py-[11px] lg:py-[13px] rounded-full no-underline border border-white/20 hover:border-white transition-colors"
              >
                <span

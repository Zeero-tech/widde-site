    ...
    <section aria-labelledby="func-heading" className="bg-surface-dark py-8 md:py-12 lg:py-16">
      <div className="max-w-screen-xl mx-auto px-5 md:px-10 lg:px-12 xl:px-6">
        <SectionTitle
          ...
          title="Tudo que você precisa para converter com Video Commerce"
          id="func-heading"
          className="mb-8"
        />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-5 lg:gap-6 mt-8">
          <div className="bg-surface border border-neutral-200 rounded-2xl p-6 md:p-6 lg:p-8 hover:border-neutral-400 transition-all">
            ...
            <h4 className="text-xl md:text-xl lg:text-2xl font-semibold mb-3">Carrinho dentro do vídeo</h4>
            <p className="text-base md:text-base lg:text-lg text-neutral-600 leading-relaxed">O consumidor adiciona ao carrinho sem sair do vídeo, acelerando o processo de compra. Zero fricção entre descoberta e finalização do pedido.</p>
          </div>
          <div className="bg-surface border border-neutral-200 rounded-2xl p-6 md:p-6 lg:p-8 hover:border-neutral-400 transition-all">
            <svg className="w-10 h-10 text-neutral-900 mb-6 lg:mb-8" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>
            <h4 className="text-xl md:text-xl lg:text-2xl font-semibold mb-3">Dados por vídeo</h4>
            <p className="text-base md:text-base lg:text-lg text-neutral-600 leading-relaxed">Views, engajamento, ticket médio e conversões por vídeo. Entenda exatamente qual conteúdo vende mais.</p>
          </div>
          <div className="bg-surface border border-neutral-200 rounded-2xl p-6 md:p-6 lg:p-8 hover:border-neutral-400 transition-all">
            ...
            <h4 className="text-xl md:text-xl lg:text-2xl font-semibold mb-3">Zero impacto na velocidade</h4>
            <p className="text-base md:text-base lg:text-lg text-neutral-600 leading-relaxed">Infraestrutura própria da Widde. Os conteúdos não pesam no carregamento da loja, não importa quantos vídeos tenham no seu site.</p>
          </div>
          <div className="bg-surface border border-neutral-200 rounded-2xl p-6 md:p-6 lg:p-8 hover:border-neutral-400 transition-all">
            ...
            <h4 className="text-xl md:text-xl lg:text-2xl font-semibold mb-3">Comentários nos vídeos</h4>
            <p className="text-base md:text-base lg:text-lg text-neutral-600 leading-relaxed">Receba e responda dúvidas dos clientes diretamente nos vídeos. IA da Widde filtra e categoriza automaticamente.</p>
          </div>
        </div>
      </div>
    </section>

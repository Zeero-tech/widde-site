  ...
  return (
    <div className="bg-[#003ab9] rounded-[12px] md:rounded-[20px] px-6 py-10 md:py-16 md:px-10 lg:py-24 lg:px-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-0 md:gap-6 lg:gap-10 text-center md:text-left">
        {stats.map((stat, i) => (
          <div key={i} className="border-t md:border-t-0 md:border-l border-white/20 pt-4 md:pt-0 md:pl-4 lg:pl-6 pb-4 md:pb-0 flex md:block items-center gap-4 justify-center md:justify-start">
            <CountUp
              target={stat.target}
              prefix={stat.prefix}
              suffix={stat.suffix}

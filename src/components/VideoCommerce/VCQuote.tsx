...
export default function VCQuote() {
  ...
  return (
    <div className="bg-ink rounded-[12px] md:rounded-[20px] px-6 py-6 md:pl-[6rem] md:pl-[3.5rem] md:py-[3.5rem] flex flex-col md:flex-row items-center gap-10 md:gap-30">
      {/* Video — top on mobile, right on desktop */}
      <div className="flex-shrink-0 w-full max-w-[250px] md:w-[280px] md:max-w-none mx-auto md:mx-0 md:order-2 md:flex md:items-center md:justify-center">
        <div
      ...
      <div className="flex-1 md:max-w-[40vw] md:order-1">
        <p className="text-xl md:text-[28px] text-white leading-[1.4] font-normal mb-4 md:mb-6">
          {t("vc.quote.text")}
        </p>
        <div className="font-black md:text-xl text-white mb-[2px] md:mb-1">
          {t("vc.quote.author")}
        </div>
        <div className="text-base md:text-xl text-white/50 mb-4 md:mb-6">{t("vc.quote.company")}</div>
        <AnimatedButton
          href="/?scrollTo=demo2"

    ...
    <section id="planos" className="pt-10 md:pt-30" aria-labelledby="planos-heading">
      ...
      <div className="grid gap-4 grid-cols-1 lg:grid-cols-[1fr_2fr]">
        ...
        <article className="bg-[#f6f6f6] border border-[#E9E9E9] rounded-[18px] p-9 relative">
          ...
          <p className="text-[14px] text-[#888] mb-4">Para lojas em fase inicial de conteúdo</p>
          <ul className="list-none flex flex-col gap-2 mb-5">
            {[
              ...
              <li key={f} className="text-[12px] text-[#5d5d5d] flex items-start gap-2 leading-[1.4]">
        ...
        <article className="bg-[#0A0A0A] border border-[#0A0A0A] rounded-[18px] p-9 relative overflow-visible">
          ...
          <div className="text-[32px] font-normal text-white mb-1">Sob medida para o seu negócio</div>
          <p className="text-[14px] text-white/45 mb-4">Fale com vendas para montar o plano ideal</p>
          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1 flex flex-col">
              <div className="bg-brand/20 rounded-[12px] p-4 mb-4">
                <h4 className="text-[14px] font-black text-white mb-1">Para marcas que querem crescer de verdade</h4>
